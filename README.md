...
玄枢是一个本地优先的综合术数工作台，当前提供 Web、Electron 和 Android 三种运行形态，包含八种排盘能力、事项引导、典籍检索、引用回链、案例本及可选 AI 精解。
...
详细产品路线图见 `玄枢五术综合占卜工作台开发计划_v8_完整版.md`。路线图包含尚未实现的规划，判断当前能力时应以 Wiki、测试和源码为准。
